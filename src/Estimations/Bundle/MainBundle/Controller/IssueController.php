...
//
//        $entities = $em->getRepository('EstimationsMainBundle:Issue')->findAll();
//
//        return $this->render('EstimationsMainBundle:Issue:index.html.twig', array(
//            'entities' => $entities,
//        ));
//    }
    /**
...
//
//        return $this->render('EstimationsMainBundle:Issue:show.html.twig', array(
//            'entity'      => $entity,
...
//        $deleteForm = $this->createDeleteForm($id);
//
//        return $this->render('EstimationsMainBundle:Issue:edit.html.twig', array(
//            'entity'      => $entity,
