...
class LoadIssueData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $socialNetwork1->setTimeSpent(4560);
        ...
        $socialNetwork2->setTimeSpent(2460);
        ...
        $socialNetwork3->setTimeSpent(1080);
        ...
        $socialNetwork4->setTimeSpent(600);
        ...
        $socialNetwork5->setTimeSpent(240);
        ...
        $socialNetwork6->setTimeSpent(1500);
        ...
        $socialNetwork7->setTimeSpent(1800);
        ...
        $socialNetwork8->setTimeSpent(120);
        ...
        $socialNetwork9->setTimeSpent(780);
        ...
        $socialNetwork10->setTimeSpent(3300);
        ...
        $socialNetwork11->setTimeSpent(600);
        ...
        $socialNetwork12->setTimeSpent(2460);
